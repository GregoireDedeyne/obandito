...
<li><a><FontAwesomeIcon icon={faHome} /> <SecondaryButton text="Accueil" /> </a></li>
  <li><a><FontAwesomeIcon icon={faSearch} /> <SecondaryButton text="Recherche" /> </a></li>
  <li><a><FontAwesomeIcon icon={faEnvelope} /> <SecondaryButton text="Messagerie" /> </a></li>
  </div>
}